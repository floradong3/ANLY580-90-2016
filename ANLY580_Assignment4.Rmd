...
data(mtcars)
x <- mtcars$mpg 
 h<-hist(x, # data to be plotted for frequency distribution
         breaks=10, # berak points to have for the bar charts
         col="red", 
         xlab="Miles Per Gallon", 
          main="Histogram with Normal Curve") 
 xfit<-seq(min(x),max(x),length=40) # adding a trend line to the histogram
