...
## Ying	Dong
The code below is my example of a heatmap using the mtcars dataset. A heatmap is a graphical representation of data where the individual values contained in a matrix are represented by colors. 
The heatmap function contains different options to show the color schemes used to show the degree of the car characteristics by model. 
```{r}
data(mtcars)
